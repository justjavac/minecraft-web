...
describe('矿石生成器', () => {
  const flatTerrain = { heightAt: () => 30, biomeAt: () => 'plains' as const, treeAt: () => null, caveAt: () => false, snowlineAt: () => Infinity };
  ...
  it('World 生成的 chunk 含基岩', () => {
    const w = new World('ore-e2e', undefined, { heightAt: () => 30, biomeAt: () => 'plains' as const, treeAt: () => null, caveAt: () => false, snowlineAt: () => Infinity });
