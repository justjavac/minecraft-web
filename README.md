...
- **16 种群系**（温度/湿度/侵蚀/奇异度多噪声分类，向 MC 1.18+ 看齐）：平原、森林、白桦林、黑森林、针叶林（灰化土斑块）、雪原（冰封水面）、沙漠、热带草原、丛林、沼泽、恶地（彩色陶瓦台地）、山地、蘑菇岛（深海菌丝岛）、海洋、河流、湖泊盆地
...
- **草色随群系变化**（MC 招牌观感）：热带草原橄榄绿、丛林浓绿、沼泽暗绿、恶地灰绿；云杉/白桦叶为 MC 固定色
- **结构**：平原/热带草原/针叶林/雪原/沙漠村庄（材质随群系：橡木/金合欢/云杉/砂岩）、哨塔、冰屋、**沙漠神殿**（阶梯金字塔 + 密藏室 4 宝箱 + TNT 陷阱层）、**丛林神庙**（苔石殿 + 明暗双宝箱，战利品含竹子），白天村庄附近有村民
- **地下**：基岩层打底，y≤16 渐变为深板岩（深层矿变体同效）；矿石按 MC 分布——煤三角峰中层（山地增量）、铁双峰（中层主峰 + 山地点峰）、铜峰中层、金深层（**恶地富矿带**）、青金石中层、红石/钻石深层（钻石越深越多）、**绿宝石只出山地**；**洞穴群系**：滴水石洞（石笋/倒挂钟乳）与繁茂洞穴（苔藓 + 杜鹃花丛 + 洞穴藤蔓）；深层洞腔更大，y≤10 有岩浆湖
...
- 脚本：`pnpm dev` / `pnpm test`（vitest 202 用例）/ `pnpm lint` / `pnpm build`（静态导出 `out/`，离线可构建，可部署到任意静态托管）
